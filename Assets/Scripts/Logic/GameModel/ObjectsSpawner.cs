...
{
    public event Action<IMoveObject> OnObjectSpawn;

    public readonly List<IMoveObject> AllSpawned;
    ...
    public void UpdateSpawnObjects()
    {
        ...
        spawnQuene = new List<SpawnData> {
            ...
            new SpawnData() { time = 3.5f, GetObject = CreateUFO },
            new SpawnData() { time = 10, GetObject = CreateUFO },
            new SpawnData() { time = 11, GetObject = CreateUFO },
            new SpawnData() { time = 17, GetObject = CreateUFO },
            new SpawnData() { time = 25, GetObject = CreateUFO },
        };
    ...
    {
        return new ShipUFOModel(GetRandomPositionOnBorder(), player, Config.UFO_SIZE, Config.UFO_ACCELERATION);
    }
